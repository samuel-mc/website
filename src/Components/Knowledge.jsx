...
const KnowledgeItem = ({ darkMode, icon, name }) => {
  const itemClass = `knowledge__item ${ darkMode ? 'dark' : ''}`;

  return (
  <div className={itemClass}>
    <i className={`${icon} fa-2x knowledge__icon`}></i>
  ...
  return (
    <Container>
      ...
      <div className="knowledge">
        ...
        <KnowledgeItem darkMode={darkMode} icon="fas fa-code" name="Tailwind" />
        ...
        <KnowledgeItem darkMode={darkMode} icon="fas fa-leaf" name=" Spring " />
