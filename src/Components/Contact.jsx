...
const Contact = () =>
    <section className="container" id="contact">
        ...
        <div className="contact">
            ...
            <a className="contact__item" href="https://www.linkedin.com/in/samuel-mc/" target="_blank">
                <i className="fab fa-linkedin fa-3x contact__icon"></i>
                <span className="contact__name">Linkedin</span>
            </a>
            <a className="contact__item" href="https://github.com/samuel-mc" target="_blank">
